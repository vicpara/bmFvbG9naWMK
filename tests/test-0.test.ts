...
import simpleTestDataRaw from './data/test-data-0.json';

let simpleTestData: any;
let reflowService: ReflowService;

beforeAll(() => {
  simpleTestData = simpleTestDataRaw;
  reflowService = new ReflowService(Object.values(simpleTestData.workCenters));
});
